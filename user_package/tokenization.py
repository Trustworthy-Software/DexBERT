...
class DeTokenizer(object):
    '''Do some reverse operations for tokens.
       To be improved !!!!!!!!!!!!
    '''
 
    @staticmethod
    def convert_tokens_to_string(tokens: list) -> str:
        '''The input should be a list of odered tokens.
    ...
    @staticmethod
    def read_dic_to_set(file_path: str) -> set:
        '''
        ...
        '''
        token_list = open(file_path, 'r').readlines()
        token_set  = {}
        for id, token in enumerate(token_list):
            token_set[id] = token.strip()
        return token_set

    @staticmethod
    def convert_ids_to_tokens(token_ids: list, dic: set) -> list:
        '''
        ...
        ''' 
        return [dic[int(id)] for id in token_ids]
    
    @staticmethod
    def DeTokenize(token_ids: list, vocab_path: set) -> str:
        '''
        Given a lsit of token ids and the token vocabulary path, return the correponding detokenized sentence.
        '''
        return DeTokenizer.convert_tokens_to_string(DeTokenizer.convert_ids_to_tokens(token_ids, DeTokenizer.read_dic_to_set(vocab_path)))